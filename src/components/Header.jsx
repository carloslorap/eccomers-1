  ...
  return (
    ...
    <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary'>
        ...
        <div className='hidden md:flex w-full items-center justify-between'>
            ...
            className='w-10 min-w-[40px] min-h-[40px] drop-shadow-xl cursor-pointer rounded-full'onClick={login}/>
            {
                isMenu &&( 
                    <motion.div 
                ...
                { 
                 user && user.email === "carloslorapuma@gmail.com" && (
                 <Link to={"/createItem"}> <p className='px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base'
                  >
                    New Item<MdAdd />
                    </p>
                    </Link>
